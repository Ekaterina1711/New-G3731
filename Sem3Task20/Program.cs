...
// PrintData("Расстояние между точками: ",CalcLen(ReadData("Введите координату X1"),ReadData("Введите координату X2"),ReadData("Введите координату Y1"),ReadData("Введите координату Y2")));
